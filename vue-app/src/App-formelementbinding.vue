...
const truthyValue = ref('Available')
...
<template>
    ...
    <div>
        ...
        <input type="checkbox" id="checkbox"  v-model="checked" false-value="Not Available" :true-value="truthyValue"/>
        <!-- <label for="checkbox">{{checked ? "Available" : "Not Available"}}</label> -->
